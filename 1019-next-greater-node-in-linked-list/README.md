...
<p>Return an integer array <code>answer</code> where <code>answer[i]</code> is the value of the next greater node of the <code>i<sup style="">th</sup></code> node (<strong>1-indexed</strong>). If the <code>i<sup style="">th</sup></code> node does not have a next greater node, set <code>answer[i] = 0</code>.</p>
...
<ul>
	...
	<li><code>1 &lt;= Node.val &lt;= 10<sup style="">9</sup></code></li>
</ul>
</div>